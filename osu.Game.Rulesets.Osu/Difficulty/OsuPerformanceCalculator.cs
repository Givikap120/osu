...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    ...
    {
        public const double PERFORMANCE_BASE_MULTIPLIER = 1.085; // This is being adjusted to keep the final pp value scaled around what it used to be when changing things.
        ...
        private OsuPerformanceAttributes calculatePerformanceAttributes(ScoreInfo score, OsuDifficultyAttributes osuAttributes)
        {
            ...
            double totalValue =
                DifficultyCalculationUtils.Norm(PERFORMANCE_NORM_EXPONENT, mechanicalValue, accuracyValue)
                + cognitionValue;
        ...
        private double computeAccuracyValue(ScoreInfo score, OsuDifficultyAttributes attributes)
        {
            ...
            double accuracyValue = Math.Pow(1.52163, overallDifficulty) * Math.Pow(betterAccuracyPercentage, 24) * 2.92;
