...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        private double calculateEstimatedSliderBreaks(double topWeightedSliderFactor, OsuDifficultyAttributes attributes)
        {
            ...
            double estimatedSliderBreaks = effectiveMissCount * topWeightedSliderFactor * 0.75;

            // Scores with more Oks and Mehs are more likely to have slider breaks.
            double mistakeLikelyhoodAdjustment = Math.Max(totalHits + nonMissMistakes * 4, 2) / totalHits;
            ...
            return estimatedSliderBreaks * mistakeLikelyhoodAdjustment * DifficultyCalculationUtils.Logistic(missedComboPercent, 0.33, 15);
        }
